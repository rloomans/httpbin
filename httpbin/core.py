...
template = {
    ...
    "info": {
        "title": "httpbin",
        "description": (
            "A simple HTTP Request & Response Service based on Kenneth Reitz's httpbin."
            "<br/> <br/> <b>Run locally: </b> <code>$ docker run -p 80:80 simonkowallik/httpbin</code>"
        ),
#        "contact": {
...
#        },
    ...
    "host": "httpbin",  # overrides localhost:5000
